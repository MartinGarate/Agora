...
{
    /// <inheritdoc />
    public partial class AddDespuesDeClases : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 30, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Aprende los conceptos básicos de programación.", new DateTime(2025, 8, 30, 16, 14, 0, 205, DateTimeKind.Local).AddTicks(4857), true, false, "Introducción a la Programación", "Carlos Gómez" },
                    { 2, 25, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Crea aplicaciones web modernas con ASP.NET Core.", new DateTime(2025, 9, 9, 16, 14, 0, 205, DateTimeKind.Local).AddTicks(4879), true, false, "Desarrollo Web con ASP.NET Core", "Ana Martínez" }
                });
